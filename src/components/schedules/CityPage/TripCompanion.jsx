		...
		<>
			...
			<div>
				<Button
					...
					active={isSingleSelected(stepStatus, "alone")}
				/>
				<Button
					text="친구와"
					id="friend"
					handleClick={handleClick}
					active={isSingleSelected(stepStatus, "friend")}
				/>
				<Button
					text="연인or배우자와"
					id="couple"
				...
				<Button
					...
					id="child"
					handleClick={handleClick}
					active={isSingleSelected(stepStatus, "child")}
				/>
				<Button
					text="부모님과"
					id="parents"
				...
				<Button
					...
					id="other"
					handleClick={handleClick}
					active={isSingleSelected(stepStatus, "other")}
				/>
			</div>
		</>
	);
